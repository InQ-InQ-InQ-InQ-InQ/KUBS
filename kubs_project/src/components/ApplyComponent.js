    ...
    <>
      ...
      <div className="apply-box" >
        <Nav variant="tabs" defaultActiveKey="link-0" className="justify-content-end">
          <Nav.Item>
            <Nav.Link onClick={()=>{ tabSet(0) }} eventKey="link-0">B1</Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link onClick={()=>{ tabSet(1) }} eventKey="link-1">1층</Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link onClick={()=>{ tabSet(2) }} eventKey="link-2">2층</Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link onClick={()=>{ tabSet(3) }} eventKey="link-3">3층</Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link onClick={()=>{ tabSet(4) }} eventKey="link-4">4층</Nav.Link>
          </Nav.Item>
          <Nav.Item>
        ...
        <div className="date-box">
          <div style={{ margin: 'auto', width: '90%', textAlign: 'center' }}>
            ...
            <Calendar onChange={setDate} // useState로 포커스 변경 시 현재 날짜 받아오기
            ...
            <ToggleButtonGroup type="radio" name="options">
              <ToggleButton id="1h" value={1} variant="dark" style={{ paddingLeft: '20px', paddingRight: '20px' }} onChange={() => { setDuration('1') }}>
                1h
              </ToggleButton>
              <ToggleButton id="2h" value={2} variant="dark" style={{ paddingLeft: '20px', paddingRight: '20px' }} onChange={() => { setDuration('2') }}>
                2h
              </ToggleButton>
              <ToggleButton id="3h" value={3} variant="dark" style={{ paddingLeft: '20px', paddingRight: '20px' }} onChange={() => { setDuration('3') }}>
                3h
              </ToggleButton>
            </ToggleButtonGroup>
...
//                availableSet(response.data.map(row=>row.available))
          ...
          <TabContent aryID={aryID} tab={tab} setShow={setShow} setTitle={setTitle} aryIDSet={aryIDSet} aryclassSet={aryclassSet}
          layer0Class={layer0Class} layer0ID={layer0ID} layer0Available={layer0Available}
          layer1Class={layer1Class} layer1ID={layer1ID} layer1Available={layer1Available}
          layer2Class={layer2Class} layer2ID={layer2ID} layer2Available={layer2Available}
          layer3Class={layer3Class} layer3ID={layer3ID} layer3Available={layer3Available}
          layer4Class={layer4Class} layer4ID={layer4ID} layer4Available={layer4Available}
          layer5Class={layer5Class} layer5ID={layer5ID} layer5Available={layer5Available}
          layer6Class={layer6Class} layer6ID={layer6ID} layer6Available={layer6Available}
            />
