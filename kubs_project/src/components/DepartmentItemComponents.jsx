...
function DepartmentItemComponent({ department, onDepartmentHandler }) {
  return (
    <div className="departmentItem" onClick={() => onDepartmentHandler(department.id, department.departmentName)}>
